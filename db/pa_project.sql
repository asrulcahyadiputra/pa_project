...
--
-- Host: localhost:8889
-- Generation Time: Oct 26, 2020 at 01:05 PM
...
CREATE TABLE `type_of_project` (
  ...
  `t_project_last_price` double NOT NULL DEFAULT '0',
  `date_created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `created_by` bigint(20) NOT NULL,
...
--
ALTER TABLE `general_ledger`
  ADD CONSTRAINT `general_ledger_ibfk_1` FOREIGN KEY (`acoount_no`) REFERENCES `chart_of_accout` (`account_no`),
...
ALTER TABLE `type_of_project`
  ...
  ADD CONSTRAINT `type_of_project_ibfk_4` FOREIGN KEY (`work_group_id`) REFERENCES `work_group` (`work_group_id`);

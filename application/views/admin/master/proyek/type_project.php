...
<div id="content" class="main-content">
	<div class="layout-px-spacing">
		<div class="row layout-top-spacing">
			<div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
				<a href="#addProject" class="btn btn-outline-primary mb-4 mt-4" data-toggle="modal" data-target="#addProject">
					<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus-square">
						<rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect>
						<line x1="12" y1="8" x2="12" y2="16"></line>
						<line x1="8" y1="12" x2="16" y2="12"></line>
					</svg>
					Tambah Jenis Proyek</a>
				<div class="widget-content widget-content-area br-6">
					<h3>Daftar Jenis Proyek</h3>
							...
							<tbody>
								...
								foreach ($all as $row) : ?>
									<tr>
										...
										<td>
											<a href="#editProject<?= $row['t_project_id'] ?>" data-toggle="modal" data-target="#editProject<?= $row['t_project_id'] ?>">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">Tambah Jenis Proyek</h5>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>
				</div>
				<form action="<?= site_url('Master/proyek/store') ?>" method="POST" class="needs-validation" novalidate>
	...
	<?php foreach ($all as $row) : ?>
		<div class="modal fade" id="editProject<?= $row['t_project_id'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="exampleModalLabel">Edit Jenis Proyek</h5>
						<button type="button" class="close" data-dismiss="modal" aria-label="Close">
							<span aria-hidden="true">&times;</span>
						</button>
					</div>
					<form action="<?= site_url('Master/proyek/update') ?>" method="POST" class="needs-validation" novalidate>
						<div class="modal-body">
							<div class="form-group">
								<label>Kode Kategori</label>
								<input type="text" name="t_project_id" value="<?= $row['t_project_id'] ?>" class="form-control" readonly>
							</div>
							<div class="form-group">
								<label>Nama Jenis Proyek</label>

								...
								<div class="table-responsive mb-4 mt-4">
									<table class="table table-bordered table-hover table-striped mb-4">
										...
										<tbody>
												...
												foreach ($materials as $r2) : ?>
													<?php if ($r1['work_group_id'] == $r2['work_group_id']) : ?>
														<tr>
															...
															<td><?= $r2['mb_unit'] ?></td>
															<td><?= nominal1($r2['mb_qty_budget']) ?></td>
															<td>
																<span class="text-left">Rp</span>
																<span style="float:right;"><?= nominal1($r2['mb_unit_price_budget']) ?></span>
															</td>
															<td>
																<?php
																$subtotal = $r2['mb_unit_price_budget'] * $r2['mb_qty_budget'];
																$row_sum = $row_sum + $subtotal;
																?>
																<span class="text-left">Rp</span>
																<span style="float:right;"><?= nominal1($subtotal) ?></span>
											...
											<?php endforeach ?>
											<tr>
												<td colspan="5" class="text-right"><b>Rencana Kebutuhan Material</b></td>
												<td>
													<b>
														<span class="text-left">Rp</span>
														<span style="float:right;"><?= nominal1($sum) ?></span>

															...
															foreach ($materials as $r2) : ?>
																<?php if ($r1['work_group_id'] == $r2['work_group_id']) : ?>
																	<tr>
																		...
																		<td>
																			<input type="number" name="mb_qty_budget[]" class="form-control" min="1" required>
																		</td>
																		<td>
																			<input type="text" name="mb_unit_price_budget[]" class="form-control" data-type="currency" required>
																		</td>
																	</tr>
																<?php endif ?>
															<?php endforeach ?>
